...
Transforma el dict crudo del request HTTP en objetos tipados
...
TEMPERATURA_MIN_FISICA = -89.0   # récord histórico más frío en Tierra
TEMPERATURA_MAX_FISICA = 60.0    # límite superior razonable para plantas
LUX_MIN_FISICA = 0.0
LUX_MAX_FISICA = 120_000.0       # luz solar directa en el ecuador ≈ 100 000 lux


class ErrorValidacion(ValueError):
    """Error de validación de entrada con código estructurado."""
...
def parsear_solicitud(datos: dict) -> tuple[str, float, float, float]:
    """
    Valida y extrae los campos del payload JSON.
    Lanza ErrorValidacion para cada caso de RF6:
      - parámetro ausente
      - valor no numérico
